...
- Added `CompareListing` section with links to Zillow, Redfin, Realtor.com, and Homes.com.
- Placed the comparison section before the contact area when supported by the current page layout.
